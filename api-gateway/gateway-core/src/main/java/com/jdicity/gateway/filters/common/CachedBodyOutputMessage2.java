 ...
 */
public class CachedBodyOutputMessage2 implements ReactiveHttpOutputMessage {
    ...
    public CachedBodyOutputMessage2(ServerWebExchange exchange, HttpHeaders httpHeaders) {
