...
public class RequestBodyParseFilterTest {
    ...
    void setup() throws Exception {
        ...
        String definitionString = String.format("{\"id\":\"web\",\"predicates\":" +
                        ...
                        "[{\"name\":\"SetPath\",\"args\":{\"template\":\"/test\"}},{\"name\":\"RequestBodyParse\"}]," +
    ...
    @Test
    void testRequestBodyParse_whenContentTypeIslegal_thenParseRequestBody() throws JsonProcessingException {
        String body = "abc";
        Map<String, String> bodyMap = new HashMap<>();
        bodyMap.put("data", body);
        String bodyStr = new ObjectMapper().writeValueAsString(bodyMap);

        webClient.post().uri("/hi").contentType(MediaType.APPLICATION_JSON).bodyValue(bodyStr)
