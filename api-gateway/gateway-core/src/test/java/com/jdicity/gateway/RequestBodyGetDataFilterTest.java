...
public class RequestBodyGetDataFilterTest {
    ...
    void setup() throws Exception {
        ...
        String definitionString = String.format("{\"id\":\"web\",\"predicates\":" +
                        ...
                        "[{\"name\":\"SetPath\",\"args\":{\"template\":\"/test\"}},{\"name\":\"RequestBodyGetData\"}]," +
    ...
    @Test
    void testRequestBodyGetData_whenRequest_thenGetRequestBodyData() throws Exception {
        String body = "abc";
