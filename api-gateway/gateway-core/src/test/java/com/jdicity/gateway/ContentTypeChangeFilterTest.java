...
public class ContentTypeChangeFilterTest {
    ...
    void setup() throws Exception{
        ...
        String definitionString = String.format("{\"id\":\"web\",\"predicates\":" +
                        ...
                        "[{\"name\":\"SetPath\",\"args\":{\"template\":\"/test\"}},{\"name\":\"ContentTypeChange\"}]," +
    ...
    private void setupStub(){
        wireMockServer.stubFor(get(urlEqualTo("/test")).withHeader("Content-Type",equalTo("application/json"))
    ...
    @Test
    void testContentTypeChange_whenRequest_thenTransferContentType() {
        webClient.get().uri("/hi").header("Content-Type","text/xml")
